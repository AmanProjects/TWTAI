...
**Purpose.** This document converts the project discussion into a simple operating model. The intent is to keep the group focused on three project tracks, assign one clear owner per project, maintain teams of 9-10 people including the owner, and deliver practical working proof-of-concepts rather than broad, unfocused explorations.
...
|---|---|---|---|---|
| 1. Release Notes | Release note generator and release-notes/project-update workflow. | Riffat | 9-10 including owner | <https://chat.whatsapp.com/LVEsGsjWYNQKbejrDk3kJg?s=cl&p=i&ilr=0> |
| 2. Document Intelligence Platform - Converter & Rebranding | Word to DITA-XML converter, rebranding across documents, document transformation and document cleanup. | Samyak | 9-10 including owner | <https://chat.whatsapp.com/Lg86PNJNESN1a59UeI16Cu?s=cl&p=i&ilr=0> |
| 3. Document Intelligence Platform - Draft Generator & Automated Pre-Review | Rapid first drafts from demo recordings, wiki pages, and marketing content; automated pre-review for style, completeness, gaps, and readiness. | SPD | 9-10 including owner | <https://chat.whatsapp.com/LtV9NVthRwS8Fv8WB2cbyE?s=cl&p=a&ilr=1> |

Decision deadline. Owners for all three projects must be identified by end of business today, Sunday, 21 June 2026. Once owners are confirmed, sign-ups should be closed, teams balanced, and execution started immediately so every team can present its proof-of-concept by Sunday, 05 July 2026.
...
-   Maintain the final team roster, create/own the project Git repository, and ensure only listed participants are included in project-specific communication channels.
...
All project information should be part of the repository: charter, roster, roles, README, meeting notes, decisions, assumptions, sample input references, prototype code, prompts, scripts, validation notes, demo assets, and final recommendation.
...
No critical work should live only on a personal machine, private drive, or chat thread. If a file cannot be committed directly because of permissions or confidentiality, add a clear reference, access note, or sanitized sample.
...
Meetings should be scheduled only when required and only as per the agreement of the project owner and the team members.
...
# 9. Deadline-Driven Delivery Plan
  ...
  **Milestone**                   **Deadline**      **Required Actions**                                                                               **Exit Criteria**
  ...
  Discovery and sample inputs     Wed, 24 Jun       Map workflow, collect realistic samples, define expected outputs, and agree success criteria.      Inputs, assumptions, exclusions, and success criteria are in the repo.
  ...
  Demo package ready              Wed, 02 Jul       Prepare README, screenshots, sample outputs, validation notes, demo story, and backup evidence.    Another member can follow the repo and reproduce or explain the demo.
...
6.  Create one Git repository per project by Monday, 22 June 2026, and keep the charter, roster, meeting notes, decisions, sample data references, prototype files, validation notes, README, and final demo assets in that repo.
...
# Appendix A: Clean Sign-Up Template
  ...
  **Project**                                                               **Owner**               **Members, including owner - max 10**
  ...
  Document Intelligence Platform - Converter & Rebranding                   To be confirmed         1\. Owner\
                                                                                                    2. Riffat Wyne\
                                                                                                    3. Anubhav\
                                                                                                    4. Anshita\
                                                                                                    5.\
  ...
  Document Intelligence Platform - Draft Generator & Automated Pre-Review   To be confirmed         1\. Owner\
                                                                                                    2.\
                                                                                                    3.\
                                                                                                    4.\
                                                                                                    5.\
...
**Suggested group message:**
  ...
  \
  Each team will have one owner and 9-10 members including the owner. Please sign up for only one project. Once a project reaches 10 people, additional volunteers will be redirected to another track. Owners must be identified by EOB today, Sunday, 21 June 2026. Each team is expected to deliver a working proof-of-concept, sample inputs/outputs, and a short demo summary for presentation by Sunday, 05 July 2026. Each project must also maintain its own Git repository as the source of truth for the charter, roster, meeting notes, decisions, prototype files, README, validation notes, and demo assets.\
  \
